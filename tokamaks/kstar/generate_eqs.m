...
% load circ and tok
circ = kstar_circ();
tok = load('kstar_obj_mks_struct_2015_3333.mat').tok_data_struct;
...
for elong = [1.7 1.9 2.1]
  ...
  [spec, init, config] = gsdesign_kstar_easyload('LSN', tok, circ);
...
for elong = [1.4 1.6 1.8]
  ...
  [spec, init, config] = gsdesign_kstar_easyload('LIM', tok, circ);
